...
set(CMAKE_C_COMPILER "${CMAKE_CURRENT_LIST_DIR}/ngage-cc.bat")
set(CMAKE_CXX_COMPILER "${EPOC_PLATFORM}/gcc/bin/g++")
...
function(build_exe_static TARGET EXTENSION UID1 UID2 UID3 STATIC_LIBS LIBS)
  ...
  add_custom_target(${TARGET}.${EXTENSION} ALL
    ...
    COMMAND ${EPOC_PLATFORM}/Tools/petran ${CMAKE_CURRENT_BINARY_DIR}/${TARGET}.${EXTENSION}_Intermediate ${CMAKE_CURRENT_BINARY_DIR}/${TARGET}.${EXTENSION} -nocall -uid1 ${UID1} -uid2 ${UID2} -uid3 ${UID3} -stack 500000 -heap 1000000 20000000
  )
endfunction()
